...
def public_scholar_login_page():
    ...
    with st.container():
        ...
        with login_col.container(border=False, key="scholar-login-form"):
            with st.form("scholar_login_form", clear_on_submit=False, border=False):
        ...
        with info_col.container(border=False, key="scholar-login-info"):
            st.write("""
